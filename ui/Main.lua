...
local function OpenClose()
  ...
  local Close_ImageButton = Custom:Create("ImageButton", {
    ...
    Image = "rbxassetid:/72383721521184",
    Visible = false,
  }, ScreenGui)
...
local Vexora_Library, Notification = {}, {}

Vexora_Library.Unloaded = false

function Vexora_Library:SetNotification(Config)
...
function Vexora_Library:CreateWindow(Config)
  local Title = Config[1] or Config.Title or ""
  local Description = Config[2] or Config.Description or ""
  ...
  local VexoraHubGui = Custom:Create("ScreenGui", {
    ZIndexBehavior = Enum.ZIndexBehavior.Sibling
  }, RunService:IsStudio() and Player.PlayerGui or (gethui() or cloneref(game:GetService("CoreGui")) or game:GetService("CoreGui")))
  ...
  local DropShadowHolder = Custom:Create("Frame", {
    ...
    ZIndex = 0,
    Name = "DropShadowHolder",
    Position = UDim2.new(0, (VexoraHubGui.AbsoluteSize.X // 2 - 455 // 2), 0, (VexoraHubGui.AbsoluteSize.Y // 2 - 350 // 2))
  }, VexoraHubGui)
  ...
  Close.Activated:Connect(function()
    ...
    if VexoraHubGui then VexoraHubGui:Destroy() end
		if not Vexora_Library.Unloaded then Vexora_Library.Unloaded = true end
	end)
